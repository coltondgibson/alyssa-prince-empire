...
import redCarpetPhoto from "@/assets/alyssa-red-carpet.jpg";
  ...
  return (
    <section className="relative w-full overflow-hidden">
      ...
      <div className="relative min-h-[75vh] flex items-center justify-center">
        <img src={womenPhoto} alt="Community of women" className="absolute inset-0 w-full h-full object-cover object-[center_15%]" loading="lazy" width={1920} height={1080} />
