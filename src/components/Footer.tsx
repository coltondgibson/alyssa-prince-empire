    ...
    <footer className="bg-brand-black py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-10">
          ...
          <p className="font-body text-xs md:text-sm tracking-[0.12em] text-card/60 text-center">
        ...
        {/* Disclaimer */}
        <p className="font-body text-[11px] leading-relaxed text-card/40 text-center max-w-4xl mx-auto">
