...
const GlitterEffect = () => {
  ...
  useEffect(() => {
    ...
    const drawCrystal = (p: Particle) => {
      ...
      grad.addColorStop(0, "rgba(235, 160, 180, 0.7)");
      grad.addColorStop(0.4, "rgba(245, 190, 205, 0.5)");
      grad.addColorStop(0.7, "rgba(230, 170, 190, 0.6)");
      grad.addColorStop(1, "rgba(210, 140, 165, 0.4)");
      ctx.fillStyle = grad;
      ctx.fill();
